<template>
  <base-nav v-model="showMenu" class="navbar-absolute top-navbar" type="white" :transparent="true">
    ...
    <ul class="navbar-nav ml-auto">
      <base-dropdown :isOpen="true" tag="li" :menu-on-right="false" title-tag="a" class="nav-item" title-classes="nav-link"
        ...
        <li class="nav-link">
          <a href="/admin" class="nav-item dropdown-item">Admin</a>
        </li>
